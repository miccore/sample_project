...
namespace Miccore.Clean.Sample.Core.Tests.Helpers.Builders
{
    public class ExpressionBuilderTests
    {
        ...
        [Fact]
        public void ReplaceParameterVisitor_ShouldImplementIEnumerable()
        {
            // Arrange
            var parameter1 = Expression.Parameter(typeof(SampleEntity), "e1");
            var parameter2 = Expression.Parameter(typeof(SampleEntity), "e2");
            ...
            // Act - Test GetEnumerator
            var enumerator = visitor.GetEnumerator();
            var count = 0;
            while (enumerator.MoveNext())
            {
                count++;
                enumerator.Current.Key.Should().Be(parameter1);
                enumerator.Current.Value.Should().Be(parameter2);
            }
        ...
        [Fact]
        public void And_WhenFirstConditionIsFalse_ShouldReturnFalse()
        {
            // Arrange
            Expression<Func<SampleEntity, bool>> expr1 = e => e.Id > 10;
            Expression<Func<SampleEntity, bool>> expr2 = e => e.Name == "Test";
            var entity = new SampleEntity { Id = 1, Name = "Test" };

            // Act
            var combinedExpression = expr1.And(expr2);
            var result = combinedExpression.Compile()(entity);
        ...
        [Fact]
        public void Or_WhenBothConditionsAreFalse_ShouldReturnFalse()
        {
            // Arrange
            Expression<Func<SampleEntity, bool>> expr1 = e => e.Id > 10;
            Expression<Func<SampleEntity, bool>> expr2 = e => e.Name == "Other";
            var entity = new SampleEntity { Id = 1, Name = "Test" };
